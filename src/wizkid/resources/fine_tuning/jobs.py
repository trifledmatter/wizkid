...
class Jobs(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        [Learn more about fine-tuning](https://platform.wizkid.com/docs/guides/fine-tuning)

        Args:
          model: The name of the model to fine-tune. You can select one of the
              [supported models](https://platform.wizkid.com/docs/guides/fine-tuning/what-models-can-be-fine-tuned).

          training_file: The ID of an uploaded file that contains training data.

              See [upload file](https://platform.wizkid.com/docs/api-reference/files/upload)
              for how to upload a file.

              Your dataset must be formatted as a JSONL file. Additionally, you must upload
              your file with the purpose `fine-tune`.

              See the [fine-tuning guide](https://platform.wizkid.com/docs/guides/fine-tuning)
              for more details.
          ...
          suffix: A string of up to 18 characters that will be added to your fine-tuned model
              ...
              `ft:gpt-3.5-turbo:wizkid:custom-model-name:7p4lURel`.

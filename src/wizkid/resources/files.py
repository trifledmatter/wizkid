...
class Files(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Assistants. See the
        [Assistants Tools guide](https://platform.wizkid.com/docs/assistants/tools) to
        learn more about the types of files supported. The Fine-tuning API only supports
        `.jsonl` files.

        Please [contact us](https://help.wizkid.com/) if you need to increase these
        storage limits.
        ...
        Args:
          ...
          purpose: The intended purpose of the uploaded file.
              ...
              Use "fine-tune" for
              [Fine-tuning](https://platform.wizkid.com/docs/api-reference/fine-tuning) and
              "assistants" for
              [Assistants](https://platform.wizkid.com/docs/api-reference/assistants) and
              [Messages](https://platform.wizkid.com/docs/api-reference/messages). This allows

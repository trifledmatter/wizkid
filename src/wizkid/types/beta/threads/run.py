...
class Run(BaseModel):
    ...
    """
    The ID of the
    [assistant](https://platform.wizkid.com/docs/api-reference/assistants) used for
    ...
    file_ids: List[str]
    """
    The list of [File](https://platform.wizkid.com/docs/api-reference/files) IDs the
    [assistant](https://platform.wizkid.com/docs/api-reference/assistants) used for
    this run.
    """
    ...
    thread_id: str
    """
    The ID of the [thread](https://platform.wizkid.com/docs/api-reference/threads)

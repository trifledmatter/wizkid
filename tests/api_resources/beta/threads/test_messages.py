...
from wizkid.types.beta.threads import Message
...
class TestMessages:
    ...
    @parametrize
    def test_path_params_create(self, client: Wizkid) -> None:
...
class TestAsyncMessages:
    ...
    @parametrize
    async def test_path_params_create(self, async_client: AsyncWizkid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
